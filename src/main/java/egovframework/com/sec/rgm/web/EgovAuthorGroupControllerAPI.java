...
public class EgovAuthorGroupControllerAPI {
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="권한그룹관리", listUrl="/sec/rgm/EgovAuthorGroupListAPI.do", order = 70,gid = 20)
    @RequestMapping(value="/sec/rgm/EgovAuthorGroupListAPI.do")
	public ResultVO selectAuthorGroupList(@ModelAttribute("authorGroupVO") AuthorGroupVO authorGroupVO) throws Exception {
        ...
        resultMap.put("authorGroupList", authorGroupVO.getAuthorGroupList());
    	...
    	resultMap.put("authorManageList", authorManageVO.getAuthorManageList());
