...
@RestController
public class EgovMenuCreateManageControllerAPI {
	...
	@RequestMapping(value = "/sym/mnu/mcm/EgovMenuCreatManageSelectAPI.do")
	public ResultVO selectMenuCreatManagList(ComDefaultVO searchVO) throws Exception {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/EgovMenuCreatSelectAPI.do")
	public ResultVO selectMenuCreatList(MenuCreatVO menuCreatVO) throws Exception {
		ResultVO resultVO = new ResultVO();
		// 0. Spring Security 사용자권한 처리
	//	Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
	//	if (!isAuthenticated) {
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/sym/mnu/mcm/EgovMenuCreatInsertAPI.do")
	public ResultVO insertMenuCreatList(@RequestBody HashMap<String,String> insertAuthorMap, 
	...
	//	    return resultVO;
	//	}
		System.out.println("p1 - "+insertAuthorMap.get("checkedAuthorForInsert"));
		System.out.println("p2 - "+insertAuthorMap.get("checkedMenuNoForInsert"));
		HashMap<String,Object> result = new HashMap<>();
		//System.out.println("p2 - "+checkedMenuNoForInsert);
		
		String checkedAuthorForInsert = insertAuthorMap.get("checkedAuthorForInsert");
		String checkedMenuNoForInsert = insertAuthorMap.get("checkedMenuNoForInsert");
		String[] insertMenuNo = insertAuthorMap.get("checkedMenuNoForInsert").split(",");
	...
	//	}
		...
		/* 사이트맵 파일 생성 위치 지정 */
		//String currentPath = EgovMenuCreateManageControllerAPI.class.getResource("").getPath();
		String currentPath = EgovMenuCreateManageControllerAPI.class.getProtectionDomain().getCodeSource() == null ? "" : EgovStringUtil.isNullToString(EgovMenuCreateManageControllerAPI.class.getProtectionDomain().getCodeSource().getLocation().getPath());
