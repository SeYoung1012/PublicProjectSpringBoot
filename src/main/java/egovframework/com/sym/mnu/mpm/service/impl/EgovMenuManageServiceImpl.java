...
public class EgovMenuManageServiceImpl extends EgovAbstractServiceImpl implements EgovMenuManageService {
	...
	public void insertMenuManage2(MenuManageVO vo) throws Exception {
		menuManageDAO.insertMenuManage2(vo);
	}
	...
	public void updateMenuManage2(MenuManageVO vo) throws Exception {
		menuManageDAO.updateMenuManage2(vo);
	}
...
*/
	...
	public int selectUpperMenuTreeNo(MenuManageVO vo) throws Exception{
		return menuManageDAO.selectUpperMenuTreeNo(vo); 
	}
}