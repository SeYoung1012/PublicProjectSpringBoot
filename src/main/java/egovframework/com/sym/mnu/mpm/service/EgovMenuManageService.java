...
public interface EgovMenuManageService {
	...
	void insertMenuManage2(MenuManageVO vo) throws Exception;
	...
	void updateMenuManage2(MenuManageVO vo) throws Exception;
	...
	int selectUpperMenuTreeNo(MenuManageVO vo) throws Exception;
