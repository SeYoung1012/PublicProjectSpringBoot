...
public class MenuManageDAO extends EgovComAbstractDAO{
	...
	public void insertMenuManage2(MenuManageVO vo){
		insert("menuManageDAO.insertMenuManage_S2", vo);
	}
	...
	public void updateMenuManage2(MenuManageVO vo){
		update("menuManageDAO.updateMenuManage_S2", vo);
	}
	...
	public int selectUpperMenuTreeNo(MenuManageVO vo) throws Exception{
		return (Integer)selectOne("menuManageDAO.selectUpperMenuTreeNo",vo);
	}
}