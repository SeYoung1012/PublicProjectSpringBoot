...
@RestController
public class EgovProgrmManageControllerAPI {
     ...
     * @exception Exception
     */
    @RequestMapping(value="/sym/prm/EgovProgramListDetailSelectAPI.do")
    public ResultVO selectProgrm(@RequestParam String progrmFileNm)throws Exception {
        ...
        resultMap.put("result", progrmManageVO);
    ...
    @RequestMapping(value="/sym/prm/EgovProgramListManageSelectAPI.do")
    public ResultVO selectProgrmList(ComDefaultVO searchVO) throws Exception {
        // 0. Spring Security 사용자권한 처리
    	//Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
    	//if(!isAuthenticated) {
    	//	model.addAttribute("message", egovMessageSource.getMessage("fail.common.login"));
        ...
        resultMap.put("resultList", list_progrmmanage);
     ...
     * @exception Exception
     */
    @RequestMapping(value="/sym/prm/EgovProgramListRegistAPI.do")
    public ResultVO insertProgrmList(@RequestBody ProgrmManageVO progrmManageVO,BindingResult bindingResult)throws Exception {
        ResultVO resultVO = new ResultVO();
    	// 0. Spring Security 사용자권한 처리
    	//Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
    	//if(!isAuthenticated) {
     ...
     */
    /*프로그램목록수정*/
    @RequestMapping(value="/sym/prm/EgovProgramListDetailSelectUpdtAPI.do")
    public ResultVO updateProgrmList(@RequestBody ProgrmManageVO progrmManageVO, BindingResult bindingResult)throws Exception {
    	ResultVO resultVO = new ResultVO();
     ...
     * @exception Exception
     */
    @RequestMapping(value="/sym/prm/EgovProgramListManageDeleteAPI.do")
    public void deleteProgrmList(@RequestBody ProgrmManageVO progrmManageVO)throws Exception {
    ...
    */
     ...
     * @exception Exception
     */
    @RequestMapping(value="/sym/prm/EgovProgramListSearchNewAPI.do")
    public ResultVO selectProgrmListSearchNew(ComDefaultVO searchVO)throws Exception {
        ResultVO resultVO = new ResultVO();
    	// 0. Spring Security 사용자권한 처리
        ...
        List<?> list_progrmmanage = progrmManageService.selectProgrmList(searchVO);
        result.put("list_progrmmanage", list_progrmmanage);
