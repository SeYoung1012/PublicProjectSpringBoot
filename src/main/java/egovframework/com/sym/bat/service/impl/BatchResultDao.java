...
public class BatchResultDao extends EgovComAbstractDAO {
	...
	public List<?> selectAllBatchDashBoard() throws Exception {
		return selectList("BatchResultDao.selectAllBatchDashBoard");
	}
	public List<?> selectSuccessBatchDashBoard() throws Exception {
		return selectList("BatchResultDao.selectSuccessBatchDashBoard");
	}
	public List<?> selectFailBatchDashBoard() throws Exception {
		return selectList("BatchResultDao.selectFailBatchDashBoard");
	}
