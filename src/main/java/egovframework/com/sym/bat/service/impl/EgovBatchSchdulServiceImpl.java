...
public class EgovBatchSchdulServiceImpl extends EgovAbstractServiceImpl implements EgovBatchSchdulService {
	 ...
	 */
	@Override
	public List<?> searchBatchSchdulList(BatchSchdul searchVO) throws Exception {
	 ...
	 */
	@Override
	public void createBatchResult(BatchResult batchResult) throws Exception {
		System.out.println("---------------dao위");
		batchResultDao.insertBatchResult(batchResult);
		System.out.println("---------------dao아래");
	}
	 ...
	 */
	@Override
	public void changeBatchResult(BatchResult batchResult) throws Exception {
