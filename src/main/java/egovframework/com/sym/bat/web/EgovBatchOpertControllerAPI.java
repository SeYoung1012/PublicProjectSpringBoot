...
@Controller
@RestController
public class EgovBatchOpertControllerAPI {
	...
	/** logger */
	private static final Logger LOGGER = LoggerFactory.getLogger(EgovBatchOpertControllerAPI.class);
	 ...
	 */
	@RequestMapping("/sym/bat/deleteBatchOpertAPI.do")
	public ResultVO deleteBatchOpert(@RequestBody BatchOpert batchOpert) throws Exception {
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/addBatchOpertAPI.do")
	public ResultVO insertBatchOpert(@RequestBody BatchOpert batchOpert, BindingResult bindingResult) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			resultVO.setResultCode(ResponseCode.SUCCESS.getCode());
	        resultVO.setResultMessage(ResponseCode.SUCCESS.getMessage());
	        result.put("batchOpertId", batchOpert.getBatchOpertId());
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/getBatchOpertAPI.do")
	public ResultVO selectBatchOpert(BatchOpert batchOpert) throws Exception {
		LOGGER.debug(" 조회조건 : {}", batchOpert);
		ResultVO resultVO = new ResultVO(); 
		HashMap<String,Object> result = new HashMap<>();
		BatchOpert batchresult = egovBatchOpertService.selectBatchOpert(batchOpert);
	...
	@RequestMapping("/sym/bat/getBatchOpertListAPI.do")
	public ResultVO selectBatchOpertList(BatchOpert searchVO)	throws Exception {
		ResultVO resultVO = new ResultVO();
		HashMap<String,Object> result = new HashMap<>();
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/updateBatchOpertAPI.do")
	public ResultVO updateBatchOpert(@RequestBody BatchOpert batchOpert, BindingResult bindingResult) throws Exception {
		// 0. Spring Security 사용자권한 처리
		ResultVO resultVO = new ResultVO();
		//Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		//if (!isAuthenticated) {
