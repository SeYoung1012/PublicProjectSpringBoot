...
public class EgovSysLogAspect {
	 ...
	 * @throws Exception
	 */
	@Around(value= "execution(public * egovframework.com..impl.*Impl.insert*(..))")
	 ...
	 * @throws Exception
	 */
	@Around(value = "execution(public * egovframework.com..impl.*Impl.update*(..))")
	 ...
	 * @throws Exception
	 */
	@Around(value="execution(public * egovframework.com..impl.*Impl.delete*(..))")
	 ...
	 * @throws Exception
	 */
	@Around(value="execution(public * egovframework.com..impl.*Impl.select*(..))")
