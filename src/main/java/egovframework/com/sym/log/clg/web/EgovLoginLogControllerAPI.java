...
@RestController
public class EgovLoginLogControllerAPI {
	...
	@RequestMapping(value="/sym/log/clg/SelectLoginLogListAPI.do")
	public ResultVO selectLoginLogInf(@ModelAttribute("searchVO") LoginLog loginLog
			) throws Exception{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/clg/SelectLoginLogDetailAPI.do")
	public ResultVO selectLoginLog(@ModelAttribute("searchVO") LoginLog loginLog,
