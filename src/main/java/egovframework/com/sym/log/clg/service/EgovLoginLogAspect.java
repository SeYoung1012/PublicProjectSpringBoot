...
public class EgovLoginLogAspect {
	...
	@After(value ="execution(public * egovframework.com.uat.uia.web.EgovLoginControllerAPI.actionLogin(..))" )
	...
	@Before(value = "execution(public * egovframework.com.uat.uia.web.EgovLoginControllerAPI.actionLogout(..))")
