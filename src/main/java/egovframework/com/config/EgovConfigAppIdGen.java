...
public class EgovConfigAppIdGen {
	...
	/**
     * 자료실 ID Generation  Config
     * @return
     */
    @Bean(destroyMethod = "destroy")
    public EgovTableIdGnrServiceImpl egovDataManageIdGnrService() {
        return new EgovIdGnrBuilder().setDataSource(egovDataSource)
                .setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
                .setBlockSize(10)
                .setTable("COMTECOPSEQ")
                .setTableName("DATA_ID")
                .setPreFix("DAT_")
                .setCipers(16)
                .setFillChar('0')
                .build();
    ...
    /**
     * 공지사항 ID Generation Config
     * 
     * @return
     */
    @Bean(destroyMethod = "destroy")
    public EgovTableIdGnrServiceImpl egovNoticeManageIdGnrService() {
        return new EgovIdGnrBuilder().setDataSource(egovDataSource)
                .setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
                .setBlockSize(10)
                .setTable("COMTECOPSEQ")
                .setTableName("NOTICE_ID")
                .setPreFix("NTC_")
                .setCipers(16)
                .setFillChar('0')
                .build();
    ...
    @Bean(destroyMethod = "destroy")
	public EgovTableIdGnrServiceImpl egovPrivacyLogIdGnrService() {
    	return new EgovIdGnrBuilder().setDataSource(egovDataSource)
    			.setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
    			.setBlockSize(10)
    			.setTable("COMTECOPSEQ")
    			.setTableName("PRIVACYLOG_ID")
    			.setPreFix("PRVCY_")
    			.setCipers(14)
    			.setFillChar('0')
    			.build();
    ...
    /**
     * 서비스 개선요청 관리 ID Generation Config
     * 
     * @return
     */
    @Bean(destroyMethod = "destroy")
    public EgovTableIdGnrServiceImpl egovIrmManageIdGnrService() {
        return new EgovIdGnrBuilder().setDataSource(egovDataSource)
                .setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
                .setBlockSize(10)
                .setTable("COMTECOPSEQ")
                .setTableName("SRVC_CHG_DMND_ID")
                .setPreFix("IRM_")
                .setCipers(16)
                .setFillChar('0')
                .build();
